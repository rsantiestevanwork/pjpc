...
<div class="product-wrap">
    <div class="row">
		<?php if ( !empty( $woo_product_grid_count ) ) { ?>
			<ul class="products woogrid col-xs-product-2 col-sm-product-3 col-md-product-3 col-lg-product-<?php echo esc_attr( $woo_product_grid_count ); ?> <?php echo esc_attr( $product_layout ); ?>">
			<?php } elseif ( isset( $cg_options['product_grid_count'] ) ) { ?>
				...
				<?php } else { ?>
					<ul class="products col-xs-product-2 col-sm-product-3 col-md-product-3 col-lg-product-4 <?php echo esc_attr( $product_layout ); ?>">
					<?php } ?>
