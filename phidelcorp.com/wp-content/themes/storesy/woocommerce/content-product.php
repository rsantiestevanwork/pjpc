...
if ( $cg_product_loop_type == 'storesy' ) {
?>
					...
					<?php if ( $cg_product_quick_view == 'enabled' ) { ?>
						<li>
							<div class="cg-quick-view-wrap">
								<a href="#" class="cg-quick-view" data-id="<?php echo esc_attr( $post->ID ); ?>"><?php esc_html_e( 'Quick View', 'storesy' ); ?></a>
							</div>
						</li>
					<?php } ?>
				...
				<a href="<?php the_permalink(); ?>">
					...
					<?php if ( $cg_options['cg_hide_categories'] == 'no' ) { ?>
						<span class="category"><?php
							...
							echo esc_attr( $firstpart );
							?></span>
					<?php }
					?>

					<span itemprop="name" class="name"><?php the_title(); ?></span>
