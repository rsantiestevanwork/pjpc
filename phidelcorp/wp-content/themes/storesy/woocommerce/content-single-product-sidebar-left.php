...
<div itemscope itemtype="http://schema.org/Product" id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="row product-details-wrapper">
        <div class="col-lg-9 col-md-9 col-sm-12 col-lg-push-3 col-md-push-3 product-listing-wrapper">
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 col-lg-pull-9 col-md-pull-9 shop-sidebar-left widget-area">
