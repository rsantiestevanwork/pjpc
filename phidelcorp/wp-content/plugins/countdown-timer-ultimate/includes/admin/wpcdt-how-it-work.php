								...
								<div class="inside">
									<table class="form-table">
										<tbody>
											<tr>
												<th>
													<label><?php _e('Getting Started with Countdown Timer Utlimate', 'countdown-timer-ultimate'); ?>:</label>
												</th>
												<td>
													<ul>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="https://www.wponlinesupport.com/documentcountdown-timer-ultimate/?utm_source=hp&event=doc" target="_blank"><?php _e('Documentation', 'countdown-timer-ultimate'); ?></a>									
													<a class="button button-primary" href="http://demo.wponlinesupport.com/countdown-timer-ultimate-demo/?utm_source=hp&event=demo" target="_blank"><?php _e('Demo for Designs', 'countdown-timer-ultimate'); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">										
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/countdown-timer-ultimate/?utm_source=hp&event=go_premium" target="_blank"><?php _e('Go Premium ', 'countdown-timer-ultimate'); ?></a>	
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/countdown-timer-ultimate-pro/circle-countdown-timer/?utm_source=hp&event=pro_demo" target="_blank"><?php _e('View PRO Demo ', 'countdown-timer-ultimate'); ?></a>			</p>								
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">
										<p><?php _e('Enjoyed this plugin? You can help by rate this plugin', 'countdown-timer-ultimate'); ?> <a href="https://wordpress.org/support/plugin/countdown-timer-ultimate/reviews/?filter=5" target="_blank">5 stars!</a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
